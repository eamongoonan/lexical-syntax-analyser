...
public class ccalLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"Digit", "UnderScore", "VARIABLE", "CONSTANT", "IS", "RETURN", "INT", 
			"BOOL", "VOID", "MAIN", "IF", "ELSE", "TRUE", "FALSE", "WHILE", "SKIPSTATEMENT", 
			"COMMA", "SEMICOL", "COLON", "ASSIGN", "LEFTCURLYBR", "RIGHTCURLYBR", 
			"LEFTBR", "RIGHTBR", "PLUS", "MINUS", "NEG", "OR", "AND", "EQUALTO", 
			"NOTEQUALTO", "LESSTHAN", "LESSTHANOREQUAL", "GREATERTHAN", "GREATERTHANOREQUAL", 
			"WS", "NUM", "ID", "COMMENT", "MULTILINECOMMENT"
		};
	}
